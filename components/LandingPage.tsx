        ...
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-muted-foreground hover:text-primary">CDS Education</a></li>
          ...
          <div className="mt-8 pt-8 border-t border-gray-200 text-center">
            <p className="text-muted-foreground">&copy; 2023 CDS Platform. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
...
function WorkflowStep({ number, title, description }: { number: number, title: string, description: string }) {
  return (
    <li className="mb-10 ml-6">
      <span className="absolute flex items-center justify-center w-8 h-8 bg-primary rounded-full -left-4 ring-4 ring-background text-primary-foreground">
        {number}
      </span>
